...
> 装逼打脸怎么铺、爽点怎么放、无敌文怎么写、打斗和智斗怎么写，都汇总在这一页。
...
| 你在做什么 | 查阅哪个模块 |
|-----------|-------------|
| 设计装逼打脸场景 | 装逼打脸怎么拆 -> 装逼进阶：二级装逼写法 |
| 释放爽点但怕写不到位 | 爽点释放到位怎么做 |
...
| 搭建装逼舞台 | 舞台搭建法 |
| 打脸写了但不爽 | 检查：爽点释放到位怎么做 + 前置小无敌准备了吗 + 对手层级够不够 |
| 战斗场景枯燥/流水账 | 检查：战斗描写三板斧 + 情绪调动三阶法 + 缺少感官细节和身体反应 |

## 这份怎么用

这份会写得直接一点。装逼打脸和战斗描写本来就是网文里很吃劲的一块，可先看爽点怎么放，再看装逼场面怎么搭，最后看具体描写。核心句是：**该爽不爽，比毒点还毒**。
...
### 正确写法
围着最重要那一下，把各个视角写到位。放了底牌，反派就要受到对应的压制：
- 该写破防写破防
- 该写羡慕写羡慕
- 该受伤扭转战局就写扭转
- 金手指对剧情的效果必须展示得清清楚楚
...
### 执行规则
装逼方式会变，但最底下那条不变，就是得让环境里的鄙视链认下主角。
...
2. **把台子搭起来**：通过人际关系搭出分层舞台（群众层 -> 中间层 -> 最上面那层）
3. **把震惊一层层传上去**：主角行动 -> 第一层震惊 -> 传到第二层 -> 传到最上面那层 -> 最上面那层反应再压回群众层
...
- 鄙视链得对得上：你想让谁认主角，就给主角摆出那人最看重的东西
- 收口：高潮后众人对主角态度的转变，把这一轮情绪收住
...
- 主角每次装逼至少都得碰到一个角色最疼的那块，后面才会继续长事
...
### 先看这个
后宫文重点是弱化男主"主动渣"的感觉，让女主自身设定成为推动后宫的主力。

### 这里这样写
1. **女主人设先定路子**：开书前就设计好每个女主最显眼的那一面
...
### 这条别丢
男频爱情线不用写太复杂，抓住“英雄救美 + 事业舞台 + 对手衬托”这三样就够。
...
| 中魔（巫师/高武/低玄） | 法术和真气参与战斗 | 平衡招式华丽度和前后说得通 |
| 高魔（玄幻巅峰） | 抽象力量如时空 | 前后说得通比画面感更重要 |

### 战斗描写实操技巧

- 修饰词每个动作都得带信息量——读者脑中能浮现画面才算到位
- 重复使用的招式一句带过，只写效果，再用旁人震惊渲染
- 大招首次出场可以详细描写，后续使用精简为"结果概括+旁观反应"
- 白描写法要用在关键处迸发强烈情感，战斗全用白描反而不易写好
- 技能喊名是读者习惯的信号，不算出戏，但不要每次都详细重复同一个招式
- 用情绪展示境况：感叹、震惊、窃喜表现谁优谁劣

### 智斗与阴谋设计

- 智斗就是看谁先知道，谁先拿到主动
- 一环套一环的阴谋诡计得前后说得通，主角破局方式也得站得住
...
### 新媒体文先看什么
**情绪第一**：新媒体最先抓的不是剧情，是情绪。所有技巧都得围着情绪起落来用。
...
| 狠压式（最狠那档） | 在第二种基础上狠压，压到读者上头再装逼 | 不只是装逼，而是打脸+装逼一起狠狠干出来 |
...
| 狠压式（重压） | 压得越狠，打脸越爽 | 买车被狗眼看人低 -> 买下砸了 -> 再买再砸 -> 暴露身份 |
...
- [ ] **情绪节奏**：急-缓-急交替，不是全程匀速
- [ ] **以弱胜强说得通**：有明确的信息差/环境利用/心理博弈，不是靠运气
- [ ] **五不崩**：目标不缺、卖点不减、社会关系不空、上层存在不缺、成长不停
- [ ] **装逼收口**：高潮后众人对主角态度转变，把这一轮情绪收住
