...
> 各题材主要怎么写、容易歪在哪。确定题材方向后，按需翻对应模块。
...
这份是题材速查。每个题材模块主要说两件事：这一类文一般怎么下笔，最容易写歪在哪。要是跨题材缝合，就先看主题材，再看辅题材，最后再看通用建议。
...
- 避免只能靠一次性秘宝——越写越崩
- 金手指可以拆碎来写：把复杂能力拆开，一点点揉进剧情
- 没收集完成之前，就是远期期待；每收齐一片，最好都能解决至少一个冲突
- 设定要服务剧情，别反过来被设定卡死；主角得是规则里的特殊变量
...
### 先记这句
爽文说到底是"读者知道结局，但还想看中间怎么打出来"。最想看的就是变强、变富、被认可。

### 关键技法
- 升级-收获-装逼三循环是通用常用循环
- 升级带来收获（对比），收获带来装逼（震惊），装逼推动新的升级
- 收获要分层释放，额外的、不确定的收获比固定收获更有惊喜感
- 爽点就盯四个字：主角牛逼——解决问题的方式决定爽感
- 风轻云淡一指灭杀 >> 歇斯底里艰难取胜
- 该爽的时候不爽到位，观感上比毒点还毒

### 卖点先拆清
- 搞清楚最顶上的卖点，才能确定赛道和受众，盲目模仿跟风全扑
- 最顶上的卖点决定金手指资源获取方式（杀杀杀 vs 经营关系网+种田）
- 最顶上的卖点影响全书基调（轻松日常 vs 严肃热血）
...
- 搞笑不等于神经病，前后得说得通。搞笑情节得长在这本书自己的规矩里，得是意料之外，但不能胡来
- 前后说不通的神经病主角，前期可能好玩，后期读者很容易跟不上
- 玩梗这事：硬玩梗不如不玩梗——梗有生命周期，热度过了只剩尴尬
- 更顺的写法：把梗里真正好笑的那一下拆出来，再换到小说自己的情境里

---

## 轻小说/二次元风

- 这种写法主要靠戏剧性人设撑住，尤其常见于主卖美少女人设的小说
...
- 沙雕风 = 用荒诞、反常规的叙事制造笑点
- 角色行为出人意料，但前后能圆上（不是乱来，是有脑子的荒诞）
- 严肃场景被角色的沙雕行为化解，反差制造笑点
- 宗门日常 > 战斗升级：沙雕宗门风中，升级只是不起眼的元素
- 群像感强：不是一个人搞笑，而是一群人互相衬托
- 沙雕不等于降智：角色的行为要有自己的那套说法，只是那套说法很离谱
- 最大的风险：纯沙雕没有情感深度，读者笑完就忘，需要有真情实感的底色
...
- 开头几章就得把氛围立起来：雨夜、霓虹、义体改造、虚拟网络
- 避免写披着赛博皮的玄幻：力量体系要服从科技那套说法

---

## 盘点文/信息差文

- 这种题材主要靠主角手里的独有信息砸向不知情的围观者，打出震惊和装逼效果
- 知识类信息差是最顶上的爽点：读者和主角一起"碾压"不知情的世界
- 单元结构：一个盘点对象 = 一个装逼单元，循环推进
- 共鸣优先：盘点方向得挑读者能产生民族/文化/专业共鸣的内容
...
- 这种题材常用结构是：先靠“模拟”拿奖励和信息差，再回到现实推进主线、兑现期待
- 单元结构：模拟制造情绪缺口 -> 模拟中获得奖励（形成信息差）-> 现实满足期待
- 卷纲结构：模拟得知大危机/大期待 -> 多次【模拟+得奖励+现实推进】的小单元循环 -> 最终达成/解决最主打的期待
- 模拟中的信息差 = 现实装逼的筹码
...
- 这种题材常见走法是围着直播场景来写，把搞钱、装逼、对抗、整活几种爽点拧在一起
...
| 受众边界 | 目标读者群体的期待和雷点 | 用男频节奏写女频、用起点那套写番茄 |

### 基调别中途变味
- 全文基调必须贯穿如一，基调中途改变 = 最顶上的吸引力崩塌
- 基调 = 读者对"这本书在讲什么感觉"的共识
- 检查法：写完每章后问"这章和开篇的基调一致吗？"

### 题材缝合的边界感判断
- 缝合前先明确两个题材各自最顶上的卖点
- 缝合后碰撞出的看点是否跑出了原本卖点？跑出去 = 脱离边界感 = 危险
...
| 番茄小说 | 短平快、强情绪、高密度爽点 | 快节奏、不拖沓、第一章就要有钩子 | 拆解同平台同题材样本的前期结构，复用结构作用而非桥段 |
| 刺猬猫 | 整活 > 节奏，人设 > 剧情 | 动漫同人+二游读者，对"好玩"的需求大于"节奏稳定" | 适配同人、轻小说、脑洞、整活向 |
| 下沉市场 | 乐子文最能打 | 颠、搞怪、放飞自我 | 放开了写，风格要对味 |
...
- 赛道选择规则：优先选择竞争分散、近期样本有效的新兴赛道；避免进入强品牌集中且结构作用难复用的成熟赛道。
- 研究中层样本而非只分析顶流——前者结构更可复用。
- 商业化 = 尊重目标读者，私人表达不能压过最顶上的卖点和阅读体验。
...
- 网文写作先看会不会讲故事，不是先看文采、创意有多怪、知识面有多广
- 跟风 = 复用已验证的结构作用，是降低风险的方式之一
- 同质化说到底 = 跟风过程中对目标没有深加工，只是一味仿照
- 跟风没问题，问题是连行动和语气都相似——退婚流可以各种组合
- 标新立异的设定不等于创新——主流之所以是主流因为大部分人接受认同
- 真要创新，重点是把梗里真正好笑的那一下拆出来，再换到新情境里用
...
- 小说得让目标读者一眼认出最顶上的卖点，不然商业价值兑现不出来。

---

## 市场认知与创作要点

- 开书节奏这条：前期聚焦最顶上的卖点/金手指的快速展开，避免在设定和伏笔上过度投入导致正文节奏缓慢
- 一旦追求完美 -> 沉迷写设定写剧情挖伏笔 -> 正文节奏缓慢
- 信息差风险：准备层想的是后续精彩展开，正文呈现出来却是男主拖沓和女主坑队友
- 新媒体入口依赖噱头和第一眼吸引力；开篇必须立刻兑现入口承诺
- 不要东一榔头西一棒子，每段剧情都要贴着当前那道主要矛盾往前推
...
- 意象 = 给人物和剧情贴标签提升深度
- 开篇不一定非要先写冲突，也可以先写环境，但得顺，信息要自然带出来
