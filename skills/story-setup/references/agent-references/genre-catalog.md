...
> 用于拆文和写大纲时对照选择题材框架，并校准结构比例与情绪节拍。

---

## 题材选择路由

根据故事核心定位对应框架，先看大类，再看具体变体。
...
追妻发动机是全文的枢纽——没有可信的清醒拐点，后面的追妻就变成"反复骚扰"。三种发动机类型：

| 类型 | 触发方式 | 写法要点 |
|------|----------|----------|
| **失去价值型** | 女主离开后，他才发现她原来承担了什么（情绪价值/实际职能/现实资源） | 要具体：不是"才意识到爱她"，而是"某个他以前根本不注意的事现在出了问题" |
| **对比冲击型** | 看到她过得更好，或新男性出现，才真正感受到失去 | 对比物越具体越有力：不是"她变漂亮了"，而是"她用他教的菜刀技法做了一道菜，现在跟别人吃" |
| **外部代价型** | 第三方（亲友/事业/信用）出问题，让他真正付出代价才清醒 | 代价要和他的错误直接挂钩，不能是无辜被打 |

**清醒拐点必须满足的条件**：
- 他的清醒来自"失去了什么"，不是来自"她变好了所以我想要"
- 拐点必须有一个具体触发物（一句话/一个场景/一件事），不能是"慢慢意识到"
- 清醒后的第一个动作要有代价（他必须放弃/暴露/付出某样东西才能接近她）

#### 男主火葬场递进（4级）

追妻场景必须递进，不能每次都是同等力度的示好被拒。

| 级别 | 男方状态 | 女方反应 | 场景示例 |
|------|----------|----------|----------|
| 1级：试探 | 以为还有机会，没放下身段 | 冷淡/不理 | 发消息说"我们谈谈"，对方已读不回 |
| 2级：主动 | 开始真正付出，但仍带条件 | 拒绝+说原因 | 出现在她面前送东西，被直接退回 |
| 3级：卑微 | 不带条件，开始接受被拒的事实，还是不死心 | 拒绝但有内心波动 | 做了一件她以前希望他做的事，她看见了，但说"太晚了" |
| 4级：代价 | 为了追她付出了真实代价（工作/身份/关系），仍无结果 | 拒绝+内心认可但不动摇 | 读者爽感最高点 |

#### 女主内部弧线

女主不能是铁板一块的"不回头"，否则读者代入感消失。核心是**外部冷静，内部有波动，但波动不改变结果**。

| 阶段 | 外部表现 | 内部状态 | 写法 |
|------|----------|----------|------|
| 心死期 | 冷静处理每件事 | 真的不想了，只是累了 | 用具体的"不再等"行动代替情绪宣泄 |
| 新生期 | 开始过自己的生活 | 偶尔想起但不痛了 | 用闲笔（朋友/工作/小事）写出她的新节奏 |
| 被追期 | 保持距离，不软化 | 看见他的付出时会有一秒的"如果早点就好了"——但马上关掉 | 这一秒必须写出来，否则女主像机器人；但绝不能让她因此动摇行动 |
| 决断期 | 说出最终的话，或用行动结束 | 不是恨，是真的放下了 | 结尾情绪是"不遗憾"，不是"终于解气了" |
...
| 变奏 | 核心手法 | 效果 |
|------|----------|------|
| **直接拒** | 一句话挡回，不解释 | 利落，读者爽；但用多了变冷漠 |
| **沉默拒** | 看见他，继续做自己的事，没有针对他 | 比愤怒更有杀伤力；适合女主已经真正放下时 |
| **事实拒** | 用一个具体的事实说明为什么不可能（不是情绪，是逻辑） | 最有说服力；"你还是来找我问录音"这种 |
| **对比拒** | 用现在的新状态/新关系让他看到他失去了什么 | 火葬场感最强；但要控制，不能用来"报复展示" |

#### "不原谅"说服力条件

要让读者认同女主的"不原谅"，前期必须完成三个铺垫：

1. **他的错误必须是主动选择，不是无意疏忽**：他是选择了另一个优先级，不是一时糊涂。反复的、有意的选择才支撑得了"不原谅"。

2. **他的补救必须有成本但仍不够**：他做过真实的补救（否则女主显得苛刻），但补救里仍然暴露出他的优先级没有根本改变。

3. **女主必须有至少一次"本可以接受"的时刻被他亲手关掉**：即他有过一个机会，女主心里有过松动，但他的一个选择/一句话把那个窗口关死了。这个时刻是"不原谅"的终极说服力来源。

#### 追妻 vs 求和的区别

| 维度 | 求和（不是追妻） | 追妻（是追妻） |
|------|----------------|--------------|
| 认知 | 觉得她还是他的，哄一下就好 | 意识到她已经不是他的了，他需要重新追 |
| 动机 | 想恢复原状，因为现在不方便 | 想重新得到她，因为意识到她的价值 |
| 行动 | 补偿+解释，试图让她理解 | 改变优先级+真实代价，证明她是第一位 |
| 优先级 | 补救行为中仍会被其他事打断 | 补救行为是当前唯一优先级 |

**判断标准**：如果男主在追妻过程中，原来的问题根源（如另一个女人/事业优先）再次出现时，他的选择仍然不是女主——那就不是追妻，只是求和。
