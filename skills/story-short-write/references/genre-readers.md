...
> 用于梳理读者心理需求、题材生命力规律、跨网站适配、平台差异、书名/简介技法、代入感管理。选题和定位时可对照使用。
> 配合文件：题材结构骨架见 `genre-writing-formulas.md`，核心梗设计见 `genre-core-mechanics.md`。

---

## 决策路由：按决策类型选章节

> 做选题和定位决策时，可先确认你在做什么决定，再翻到对应章节。
