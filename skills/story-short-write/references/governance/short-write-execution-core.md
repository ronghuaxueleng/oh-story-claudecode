...
2. **P 拍换芯与细纲**：保留主体完整上层层级和 E 拍，逐拍重建目标 P 拍，再完成 `小节大纲.md`；只有用户明确要求时才检索热点现实机制。
3. **迁移合同**：映射主体 P 槽位、主体 E 和辅助选中 P 到目标细拍 ID，逐拍填写 P 拍换芯判断；热点来源只在用户明确启用时填写。主体 SF 六维按原文行区间和 P 映射自动派生。
