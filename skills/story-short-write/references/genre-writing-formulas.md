...
> 收录 21 个题材的结构骨架、情绪节拍、必选场景和关键规则。拿它当骨架，不要当流水线直接套。
> 优先配合当前 skill 内的通用技法 reference；如已通过 story-setup 部署项目本地 reference bundle，再结合其中的写作技法、结构格式和题材风格模块使用。

---

## 决策路由：按题材选公式

> 写之前先定位题材，再找到对应公式做结构底稿。

先记住这条总口径：

- 公式负责保底，不负责出彩
- 真正决定这篇值不值钱的，还是主冲突够不够狠、副升级器够不够顶、公开场够不够大、结果期待够不够清楚
- 如果一篇文看起来“都对”，但还是平，十有八九不是公式错了，是你把公式写成了顺排施工单
...
**补强口径**：别只写“主角反击了”，要写清她把对方往什么更难看的位置上推了
...
**补强口径**：真正值钱的是“认错人、站错队、压错人”带来的公开翻车，不只是身份亮出来
...
**补强口径**：想让“不原谅”成立，前面就得把轻慢、偏心、站错队写透
...
**补强口径**：离婚逆袭文最怕写成普通爽文，关键是把“他失去她以后才知道自己丢了什么”写具体
...
**补强口径**：别把“虐”写成重复受辱，要一层比一层更掉位、更寒心、更不能原谅
...
1. 别把公式顺着抄成流水账。每一节都要问：这一刀到底疼在哪，爽在哪，掉位在哪
2. 别只套节点，不管嘴型。人物对白必须另外回原文提口气模板
3. 别只写发生，要提前卖结果。读者得知道自己在等哪一下大的
...
## 公式二十二：现代都市/婚内追妻（现实向，8章）

> 适用场景：婚内长期伤害→女方现实撤离→男方后知后觉→追妻→女方不回头（或开放式）。
> 与公式十（架空追妻）的核心差异：没有宫斗权谋外衣，靠"现实资源/权限逐步切断"建压；男方清醒拐点不是"她变好了"，而是"我以为还有机会，结果手里什么都没了"。

### 8章节点

| 章 | 节点 | 占比 | 情绪 | 核心动作 |
|----|------|------|------|---------|
| 1 | 最后一次伤害 | 12% | 压抑→心死 | 导致女主心死的关键事件（主动选择伤害，不是无意疏忽） |
| 2 | 现实撤离 | 15% | 冷静·爽 | 账户/住所/关系权限逐一拆分，每项切断都是具体动作 |
| 3 | 男主后知后觉 | 10% | 迟钝·不安 | 他意识到妻子在认真离开，不是赌气——用一个具体事件触发 |
| 4 | 高成本补救 | 12% | 短暂松动 | 真实付出代价的补救动作，但核心问题未解（问题根源仍在） |
| 5 | 追妻发动机 | 12% | 痛快 | 清醒拐点：他发现真正失去的是什么（用具体失去物件/场景，不写"才意识到爱她"） |
| 6 | 追妻受挫×2 | 18% | 爽（打脸） | 第一次被拒（他以为可以，女主冷淡不理）；第二次卑微被拒（女主内心有一秒波动但不动摇） |
| 7 | 女主决断 | 12% | 决绝·不遗憾 | 一个具体场景把门彻底关上（用事实，不用情绪宣泄） |
| 8 | 结局 | 9% | 释放 | 不原谅型：女主进入新秩序，男主自行承担；开放型：最后一句留白 |

**情绪弧**：憋屈→心死→新生（冷静爽）→短暂松动→决绝→不遗憾

---

### 现实撤离的写法（第2章核心）

撤离不是"摔门而去"，而是一项项权限的物理切断。每项切断要写成**具体动作+外部系统回应**：

| 撤离类型 | 写法示例 |
|---------|---------|
| 账户权限 | 改工资卡独立账户→取消共同账户自动扣款，系统发确认短信 |
| 住所权限 | 交钥匙之前把东西搬完，没有等他回来的那个场景 |
| 关系权限 | 紧急联系人从丈夫改成妈妈，收到短信那一刻是外部印证 |
| 职业权限 | 申报亲属关联回避，填表时上司只问一句就不再追问 |
| 共享权限 | 关掉共享定位，退出婚庆群，不回复"婚礼倒计时7天" |

**规则**：撤离动作越物理、越不可逆，读者的爽感越强。不要写她怎么想的，只写她做了什么，系统/对方怎么回应。

---

### 追妻发动机（第5章核心）

参照 `genre-catalog.md` 追妻文核心机制中的三类发动机，现实向首选**失去价值型**：

> 不是"他才意识到爱她"，而是"某个他以前从来不注意的事，现在出了问题"。

触发物必须具体：一封系统邮件、一个没人接收的包裹、一项他以为她会处理的手续现在没人管了。

**清醒拐点必须满足**：他不是因为"她变好了"才想要，而是因为"才发现之前一直在用她"才清醒。这两种动机写出来差距极大——前者读者会嫌他，后者读者会觉得"活该但可以理解"。
...
| 次 | 男方状态 | 女方拒法 | 节拍 |
|----|---------|---------|------|
| 第一次 | 以为还有机会，没放下身段 | 沉默拒：继续做自己的事，没针对他 | 利落，读者爽 |
| 第二次 | 开始卑微，带点真实代价 | 事实拒：用一个具体事实说明为什么不可能 | 此时女主内心有一秒"如果早点就好了"——必须写出来，但立刻关掉 |

**女主那一秒波动的写法**：不能用心理旁白直接说"我心动了"，要用一个外部细节折射——她的手停了一下，她看见某个旧物件，她的脚步慢了半拍。然后下一句马上切走：她继续做手里的事。

---

### 必选场景

1. **撤离发现场**：他发现某项权限/资源已经被她提前切断（比他预想早得多），这里是全文第一个真正的惊吓点
2. **第三方印证**：外部系统/机构/中间人宣布她的撤离已生效，他无法直接撤回
3. **他拿着旧信物问"你真的不要了"**：她不直接回答，转去做另一件事
4. **最后一次门关上**：她不是愤怒地离开，是安静地转身。结尾情绪是"不遗憾"，不是"终于解气了"

---

### 关键规则

- **男方的错误必须是主动选择，不是一时糊涂**：如果只是"一次失误"，后面的不原谅就站不住脚
- **补救动作要写出真实成本，但同时暴露他的优先级仍然没有根本改变**：他做了某件事，但在另一件更小的事上，他选择了别的
- **女主不能靠大段情绪宣泄推进，但必须有可观察破绽**：她的冷静来自真的不想了，不是在忍；正文要用停顿、误拿、说错、临时改动作等小失控证明她不是铁板一块。对话中优先用具体事实/事务性回应，不用作者替她喊口号。
- **不要写"她终于报复了"的情绪**：结尾不是解气，是"这件事已经结清了，我继续我的事"
- **男方视角里的悔恨比女方视角里的坚强更有冲击力**：如果有机会切视角，写他拿着她曾经要求过的某样东西站在那里，但她已经不要了
