...
> 设计情感桥段时拿这个当速查。先按决策路由判断策略，再用三板斧把情绪落到具体段里。
...
**目标**：用具体物件、数字、细节建立关系质感，让读者先信这段关系是真的。
...
**核心**：羁绊越具体，后面的撕裂越痛。不要写“他们很相爱”这种空话。

---

### 第二斧：情感撕裂（中后段）

**目标**：制造反差，让读者以为恨对了，再发现恨错了，或者反过来。
...
**核心**：撕裂的力度取决于铺垫的厚度。前面没铺稳，后面再狠也只是热闹。

---

### 第三斧：余韵钝痛（结尾）

**目标**：不用大哭大闹，用安静细节把读者扎穿。
...
3. **最后一次转向决定结尾余韵的基调**
4. **爽文允许快速反弹，虐文需要更长铺垫**
5. **情绪不是写“难受/委屈/心寒”几个词就算到了，得让读者知道她为什么会这么疼**
...
- 额外提醒：别只写“她很爱他”，要写她到底替他做过什么、忍过什么、记得什么
...
- 额外提醒：古言也别端着，情绪照样要落地，别写成只剩设定和称呼
...
| **只有惨没有狠** | 主角一直受压，读者只觉得闷 | 提前埋动作、底牌、公开场、结果期待 |
